...
n_users = len(user)
n_items = len(item)
utility_matrix = pickle.load(open("utility_matrix.pkl", "rb"), encoding='latin1')
...
print("Rate the following movies from 0-100 points:")
...
print("Finding moive similarity.......")
...
print("The customer will love movies as:")
